...

{
    public static class Process_util
    {
        ...
        public static List<string> process_exec_output(string assembly_name, string command_line)
        {
            int rc = 0;
            ...
            try
            {
                ...
                //theApplication.StartInfo.WorkingDirectory = WorkingDir;
                ...
                //theApplication.OutputDataReceived += new DataReceivedEventHandler(ConsoleOutputHandler);
                theApplication.StartInfo.RedirectStandardInput = true;

                theApplication.Start();
                theApplication.WaitForExit(2000);  // with timout

                StreamReader sr = theApplication.StandardOutput;
        ...
        /// <summary>
        /// execute a BASH shell script using MONO. Test ok 31.01.2021
        /// </summary>
        /// <param name="assembly_name"></param>
        /// <param name="command_line"></param>
        /// <returns></returns>

        public static List<string> script_exec_output(string assembly_name, string command_line)
        {
            int rc = 0;
            List<string> output = new List<string>();
            ...
            try
            {
                Process theApplication;
                theApplication = new Process();
                theApplication.StartInfo.FileName = "/bin/bash";
                theApplication.StartInfo.Arguments = " -c '"+assembly_name + " " + command_line+"'";
                theApplication.StartInfo.UseShellExecute = false;
                theApplication.StartInfo.CreateNoWindow = true;
                theApplication.StartInfo.RedirectStandardOutput = true;
                theApplication.StartInfo.RedirectStandardError = true;
            ...
            {
                output.Add("in script_exec_output :" + ex.Message);
            }
        ...
        public static string process_create_user(string user, string password, string assembly_name, string command_line)
        {
            int rc = 0;
            string result;
            ...
            try
            {
                ...
                theApplication.StartInfo.Arguments = command_line;
                theApplication.StartInfo.UseShellExecute = false;
                theApplication.StartInfo.UserName = user;
                ...
                theApplication.StartInfo.Password = ss;
                theApplication.StartInfo.LoadUserProfile = true;
                //theApplication.StartInfo.CreateNoWindow = true;
                //theApplication.StartInfo.RedirectStandardOutput = true;
                //theApplication.StartInfo.RedirectStandardError = true;
                //theApplication.StartInfo.RedirectStandardInput = true;
